      ...
      <div className="container mx-auto">
        ...
        <div className="mb-8 sm:flex sm:items-center sm:justify-between">
          <div className="mb-4">
            ...
            <h1 className="text-5xl font-semibold text-slate-800 mb-4 sm:mb-0">{data.title}</h1>
            <a href="/places/runtun" className="text-lg font-light text-slate-700">
              Runtun
            </a>
          </div>
        ...
        <div className="sm:grid sm:grid-cols-6 gap-8 relative">
          <div className="col-span-4">
            <h2 className="text-xl font-medium">La casa del arbol en Banos Ecuador</h2>
