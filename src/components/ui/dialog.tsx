...
const DialogContent = React.forwardRef<
  React.ElementRef<typeof DialogPrimitive.Content> & { closeOutside?: boolean },
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & { closeOutside?: boolean }
>(({ className, closeOutside, children, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
